...
INSERT INTO "new_produtos" ("acabamento", "altura", "capacidade", "categoria_id", "comprimento", "created_at", "custo_acabamento", "custo_embalagem", "custo_filamento", "custo_material", "custo_modelo_3d", "custo_protecao", "custo_total", "custo_total_filam", "custo_total_uni", "desconto", "descricao", "embalagem", "id", "id_filamento", "id_impressora", "largura", "mao_obra", "materiais", "nome", "peso_usado", "preco_mkplaces", "preco_sugerido", "preco_venda_dir", "protecao", "qtd_materiais", "qtd_protecao", "sku", "sub_categoria", "tampa", "tempo_decimal", "tempo_horas", "tempo_minutos", "tempo_producao", "uni_mesa", "updated_at") SELECT "acabamento", "altura", "capacidade", "categoria_id", "comprimento", "created_at", "custo_acabamento", "custo_embalagem", "custo_filamento", "custo_material", "custo_modelo_3d", "custo_protecao", "custo_total", "custo_total_filam", "custo_total_uni", "desconto", "descricao", "embalagem", "id", "id_filamento", "id_impressora", "largura", "mao_obra", "materiais", "nome", "peso_usado", "preco_mkplaces", "preco_sugerido", "preco_venda_dir", "protecao", "qtd_materiais", "qtd_protecao", "sku", "sub_categoria", "tampa", "tempo_decimal", "tempo_horas", "tempo_minutos", "tempo_producao", "uni_mesa", "updated_at" FROM "produtos";
DROP TABLE "produtos";
